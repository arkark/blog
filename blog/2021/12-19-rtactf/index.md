...
tags:
  - ctf
image: ./img/leaky-rsa.png
---

今年のSECCONではRTACTFという早解きCTFが開催されました。

- コンテストページ: ~~https://speedrun.seccon.jp/~~
- RTACTF実況動画: https://www.youtube.com/watch?v=VXaROnAmAiY
...
> crypto<br />
> 目標：300 sec<br />
> Sexy RSA is an RSA scheme with a sexy private key.<br />
> 秘密鍵がセクシーなRSA暗号をSexy RSAと呼びます。<br />
> author: ptr-yudai
...
> crypto<br />
> 目標：900 sec<br />
> Proth RSA is an RSA scheme invented by Francois Proth in the 19th century.<br />
> フランソワ・プロスが19世紀に発明したRSA暗号をProth RSAと呼びます。<br />
> author: ptr-yudai
...
> crypto<br />
> 目標：1800 sec<br />
> Leaky RSA is an RSA scheme whose private key is partially leaked but is still considered secure.<br />
> 秘密鍵が多少漏洩しても安全と考えられているRSA暗号をLeaky RSAと呼びます。<br />
> author: ptr-yudai
...
> crypto<br />
> 目標：1800 sec<br />
> Neighbor RSA is an RSA scheme with the private key made with your neighbor.<br />
> お隣さんと秘密鍵を作ったRSA暗号をNeighbor RSAと呼びます。<br />
> author: ptr-yudai
